...
class BasicEncoderLayer(nn.Layer):
    def __init__(self, args):
        ...
        self.build_self_attn(args) # self attn
...
class DeformableEncoderLayer(BasicEncoderLayer):  # encoder 部分
    ...
    def self_attn_forward(self, src, **kwargs):
        ...
        # 上边的参数
        # query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index, input_padding_mask=None, cs_batch=None
        return src2
