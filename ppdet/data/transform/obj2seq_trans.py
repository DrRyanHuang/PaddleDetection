...
class RearrangeByCls(object):
    def __init__(self, keep_keys=["size", "orig_size", "im_id", "multi_label_onehot", "multi_label_weights", "force_sample_probs"], min_keypoints_train=0):
